CREATE TABLE 예매
(
예매번호 integer NOT NULL PRIMARY KEY,
...
CREATE TABLE 지점
(
지점번호 integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
지점명 varchar(30) NOT NULL,
특별시_광역시_도 varchar(15) NOT NULL,
구_군_시 varchar(10),
시_구 varchar(10),
동_읍_면 varchar(10),
도로명 varchar(30) NOT NULL,
...
CREATE TABLE 상영관
(
상영관번호 integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE 영화상영정보
(
상영정보번호 integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
지점번호 integer NOT NULL,
상영관번호 integer NOT NULL,
영화번호 integer NOT NULL,
일자 date NOT NULL,
영화시작시간 time NOT NULL,
영화종료시간 time NOT NULL,
